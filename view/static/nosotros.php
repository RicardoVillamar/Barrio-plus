  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      /**Selector Combinatorio de Descendientes**/
      .campo-asunto textarea {
        font-size: 0.8rem;
        border: 1px solid black;
        border-radius: 5px;
        width: 300px;
      ...
      #acercaDenosotros blockquote {
        font-size: 0.8em;
        margin-left: 20px;
      }

      /**Selector de Descendientes**/
      #acercaDenosotros figcaption {
        font-size: 0.8em;
        margin-left: 10px;
        margin-bottom: 10px;
      }
      ...
      #mision::first-line,
      #valores::first-line,
      #acercaDenosotros::first-line,
      .container h2::first-line,
      #contacto::first-line {
        text-decoration: underline;
      }
      ...
      /**Selector de Pseudoelemento**/
      #mision p::after {
        content: " Puedes consultar los siguientes videos para conocer un poco más sobre nuestra misión: ";
        font-weight: bold;
      }
      ...
      #listaValores img:hover,
      #acercaDenosotros img:hover {
    ...
    <header>
      <nav id="navbar">
        ...
        <ul style="margin-top: 14px">
          <li>
            <a href="../instalations/instalaciones.html">Instalaciones</a>
          </li>
          <li><a href="../kit/herramientas.html">Herramientas</a></li>
          <li><a href="../record/historial.html">Historial</a></li>
          <li>
            <a href="../about/nosotros.html" class="activo">Nosotros</a>
          </li>
          <li>
            <a href="#" class="user" style="display: flex; align-items: center">
      ...
      <section class="container">
        <section class="row">
          ...
          <article class="tarjeta col-md-4">
            <img
              src="../../assets/img/grupo/villamar.png"
              alt="villamar"
          ...
          <article class="tarjeta col-md-4">
            <img
              src="../../assets/img/grupo/quinionez.png"
              alt="quinionez"
              class="tarjeta-imagen"
            />
            <div class="infoIntegrante">
          ...
          <article class="tarjeta col-md-4">
            <img
              src="../../assets/img/grupo/palacios.png"
              alt="palacios"
              class="tarjeta-imagen"
            />
            <div class="infoIntegrante">
        ...
        <section class="row">
          <article class="tarjeta col-md-6">
            <img
              src="../../assets/img/grupo/larrea.png"
              alt="larrea"
              class="tarjeta-imagen"
            />
            <div class="infoIntegrante">
          ...
          <article class="tarjeta col-md-6">
            <img
              src="../../assets/img/grupo/freire.png"
              alt="freire"
              class="tarjeta-imagen"
            />
            <div class="infoIntegrante">
