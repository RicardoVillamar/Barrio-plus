...
<body>
  ...
  <section class="contenedorInstalaciones">
    ...
    <div class="elementoReservar">
      <button class="boton-mediano" onclick="window.location.href='index.php?c=instalacion&f=index'">Ir a reservar</button>
    </div>
  ...
  <section class="contenedorHerramientas">
    ...
    <div class="elementoReservar">
      <button class="boton-mediano" onclick="window.location.href='index.php?c=herramienta&f=index_Herramienta'">Ir a reservar</button>
    </div>
  ...
  <section id="publicacionesRecientes">
    ...
    <a style="margin-bottom: 18px;" class="boton-mediano" href="
      <?php
      if (!isset($_SESSION['usuario'])) {
        echo "index.php?c=usuario&f=login";
      } else {
        echo "index.php?c=publicacion&f=index";
      }
      ?>
